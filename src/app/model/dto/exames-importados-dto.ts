export class ExamesImportadosDto {
    ...
    private examesImportados: string;
    ...
    public getExamesImportados() {
        return this.examesImportados;
    }
    public setExamesImportados(examesImportados: string) {
