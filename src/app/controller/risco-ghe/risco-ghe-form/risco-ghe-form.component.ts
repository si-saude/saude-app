...
@Component({
  selector: 'app-risco-ghe-form',
  templateUrl: './risco-ghe-form.component.html',
  styleUrls: ['./risco-ghe-form.component.css', './../../../../assets/css/form-component.css']
})
export class RiscoGheFormComponent extends GenericFormComponent implements OnInit {
