...
@Component( {
    selector: 'app-solicitacao-central-integra-form-observacao',
    templateUrl: './solicitacao-central-integra-form-observacao.html',
    styleUrls: ['./solicitacao-central-integra-form.css', './../../../../assets/css/form-component.css']
} )
export class SolicitacaoCentralIntegraFormObservacaoComponent extends GenericFormComponent implements OnInit {
