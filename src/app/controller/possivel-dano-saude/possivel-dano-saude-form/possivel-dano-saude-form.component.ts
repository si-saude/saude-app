...
@Component({
  selector: 'app-possivel-dano-saude-form',
  templateUrl: './possivel-dano-saude-form.html',
  styleUrls: ['./possivel-dano-saude-form.css','./../../../../assets/css/form-component.css']
})
export class PossivelDanoSaudeFormComponent extends GenericFormComponent implements OnInit {
    ...
    save() {
        super.save( new PossivelDanoSaudeBuilder().clone(this.possivelDanoSaude ) );
    }
