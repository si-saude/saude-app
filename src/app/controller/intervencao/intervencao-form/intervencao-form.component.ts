...
@Component( {
    selector: 'app-intervencao-form',
    templateUrl: './intervencao-form.html',
    styleUrls: ['./../../../../assets/css/form-component.css', './intervencao-form.css']
} )
export class IntervencaoFormComponent extends GenericFormComponent implements OnInit { 
    ...
    save() {
        super.save(new IntervencaoBuilder().clone(this.intervencao));
    }
