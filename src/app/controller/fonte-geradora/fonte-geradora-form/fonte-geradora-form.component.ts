...
@Component({
  selector: 'app-fonte-geradora-form',
  templateUrl: './fonte-geradora-form.html',
  styleUrls: ['./fonte-geradora-form.css', './../../../../assets/css/form-component.css']
})
export class FonteGeradoraFormComponent extends GenericFormComponent implements OnInit {
    ...
    save() {
        super.save( new FonteGeradoraBuilder().clone(this.fonteGeradora ) );
    }
