...
@Component( {
    selector: 'app-item-auditoria-atestado-form',
    templateUrl: './item-auditoria-atestado-form.html',
    styleUrls: ['./../../../../assets/css/form-component.css', './item-auditoria-atestado-form.css']
} )
export class ItemAuditoriaAtestadoFormComponent extends GenericFormComponent implements OnInit { 
    ...
    save() {
        super.save(new ItemAuditoriaAtestadoBuilder().clone(this.itemAuditoriaAtestado));
    }
}