...
@Component( {
    selector: 'app-indicador-risco-sanitario-form-detail',
    templateUrl: './indicador-risco-sanitario-form-detail.html',
    styleUrls: ['./indicador-risco-sanitario-form.css', './../../../../assets/css/form-component.css']
} )
export class IndicadorRiscoSanitarioFormDetailComponent extends GenericFormComponent implements OnInit {
