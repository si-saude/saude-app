...
@Component( {
    selector: 'app-cidade-form-detail',
    templateUrl: './cidade-form-detail.html',
    styleUrls: ['./cidade-form.css', './../../../../assets/css/form-component.css']
} )
export class CidadeFormDetailComponent extends GenericFormComponent implements OnInit {
    cidade: Cidade;
