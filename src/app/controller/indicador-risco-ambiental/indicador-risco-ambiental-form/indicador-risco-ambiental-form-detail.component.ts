...
@Component( {
    selector: 'app-indicador-risco-ambiental-form-detail',
    templateUrl: './indicador-risco-ambiental-form-detail.html',
    styleUrls: ['./indicador-risco-ambiental-form.css', './../../../../assets/css/form-component.css']
} )
export class IndicadorRiscoAmbientalFormDetailComponent extends GenericFormComponent implements OnInit {
