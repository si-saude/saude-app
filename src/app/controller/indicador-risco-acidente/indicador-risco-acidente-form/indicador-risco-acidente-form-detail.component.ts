...
@Component( {
    selector: 'app-indicador-risco-acidente-form-detail',
    templateUrl: './indicador-risco-acidente-form-detail.html',
    styleUrls: ['./indicador-risco-acidente-form.css', './../../../../assets/css/form-component.css']
} )
export class IndicadorRiscoAcidenteFormDetailComponent extends GenericFormComponent implements OnInit {
    ...
    constructor( private route: ActivatedRoute,
        ...
        router: Router) { 
        super(indicadorRiscoAcidenteService, router);
