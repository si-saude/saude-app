...
@Component( {
    selector: 'app-motivo-recusa-atestado-form',
    templateUrl: './motivo-recusa-atestado-form.html',
    styleUrls: ['./motivo-recusa-atestado-form.css', './../../../../assets/css/form-component.css']
} )
export class MotivoRecusaAtestadoFormComponent extends GenericFormComponent implements OnInit {
