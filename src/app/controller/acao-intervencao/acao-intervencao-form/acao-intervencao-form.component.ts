...
@Component( {
    selector: 'app-acao-intervencao-form',
    templateUrl: './acao-intervencao-form.html',
    styleUrls: ['./acao-intervencao-form.css', './../../../../assets/css/form-component.css']
} )
export class AcaoIntervencaoFormComponent extends GenericFormComponent implements OnInit {
