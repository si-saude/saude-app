...
@Component( {
    selector: 'app-pergunta-ficha-coleta-form-detail',
    templateUrl: './pergunta-ficha-coleta-form-detail.html',
    styleUrls: ['./../../../../assets/css/form-component.css', './pergunta-ficha-coleta-form.css']
} )
export class PerguntaFichaColetaFormDetailComponent extends GenericFormComponent implements OnInit { 
